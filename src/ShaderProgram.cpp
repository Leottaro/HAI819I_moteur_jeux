...
ShaderProgram::ShaderProgram(const string& vertexShaderFilename, const string& fragmentShaderFilename) : m_vertex_path(vertexShaderFilename),
                                                                                                         m_fragment_path(fragmentShaderFilename) {
