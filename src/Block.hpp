...
public:
    ...
    static constexpr size_t BLOCK_TYPES_N = static_cast<size_t>(Type::__NUMBER_OF_TYPES);
    ...
    static constexpr std::array<glm::vec2, 4> getUV(float atlas_size, Type block_type, int face_i) {
