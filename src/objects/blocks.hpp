...
struct BlockTypeData {
    float friction;                 // Describes the friction of a bounce and staying over it
...
constexpr std::array<BlockTypeData, BLOCK_TYPES_N> BLOCK_TYPE_DATA{{
    {0.f, 0.f, 1.f, false, BlockTransparence::TRANSPARENT}, // Air
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // Stone
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // Dirt
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // Grass
    {0.5f, 0.f, 0.f, true, BlockTransparence::TRANSPARENT}, // Glass
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // IronBlock
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // RedstoneLamp
    {0.5f, 0.f, 0.f, true, BlockTransparence::SOLID},       // DiamondOre
    {0.5f, 1.f, 0.f, true, BlockTransparence::TRANSLUCENT}, // SlimeBlock
}};
